...
axios.post('https://mozahidfurniture.onrender.com/product',product)
.then(response=>{
  const {data}=response;
  console.log(data);
...
axios.post('https://mozahidfurniture.onrender.com/order',product)
.then(response=>{
  const {data}=response;
  console.log(data);
  alert('Data Add Sucess full')
...
// const url=`https://mozahidfurniture.onrender.com/product`;
// fetch(url,{
// method: 'POST',
// headers : {
